...
function rss(_args) {
	var url = 'http://www.npr.org/rss/podcast.php?id=510310';
	...
	Titanium.include('ui/handheld/ios/mashups/strip_tags.js');
		...
		for (var c=0;c < itemList.length;c++){
			...
			if(itemList.item(c).getElementsByTagName("enclosure")!=null){
				...
				var item_image = Ti.UI.createImageView({
					image:'https://media.npr.org/assets/img/2015/11/13/nprpolitics_red1400px_sq-6bc03b536409ec88fd8d3abb637b560e93865bad.png?s=200',
					left:3,
					top:2,
					width:50,
					height:34
